...
sampling more efficient. Here is how you can fit the simplest possible
SDT model, i.e., EV Normal with one threshold / criterion, to the data
from one participant in one condition:
...
estimates (method = 'jmap', which is the default) of d' (meta-d',
